...
[RVM](https://rvm.io) is a command-line tool that help developers easily install, manage and work with multiple version of Ruby.
...
![Type the following to install RVM](images/rvm_install_01.png "Type the following to install RVM")
...
![End of RVM installation](images/rvm_install_02.png "End of RVM installation")
...
![Installing Ruby 1.9.3](images/rvm_install_04.png "Installing Ruby 1.9.3")

	5. Once done, you should get the following output.

![Ruby 1.9.3 successfully installed](images/rvm_install_05.png "Ruby 1.9.3 successfully installed")
...
![Installing Rails](images/rails_install.png "Installing Rails")

Notice that Rails consists of a collection of gems, you can read more about its componenents on [Rails' GitHub](https://github.com/rails/rails) repository
...
![Installing Bundler](images/bundler_install.png "Installing Bundler")
...
![Generating a new Rails application](images/blogger_generate_01.png "Generating a new Rails application")
...
![Rails application directory structure](images/rails_app_textmate.png "Rails application directory structure")
...
![Adding gems to Gemfile](images/rails_gemfile.png "Adding gems to Gemfile")
...
![Generating home controller](images/rails_home_controller.png "Generating home controller")
...
![Rails routes default home](images/rails_routes_01.png "Rails routes default home")

	To the following:
	
	root :to => "home#index"
	
![Rails routes updated default home](images/rails_routes_02.png "Rails routes updated default home")
...
![Blogger home page](images/rails_browser_homepage.png "Blogger home page")
...
![Scaffolding Post](images/rails_create_posts.png "Scaffolding Post")
...
![Post migration](images/rails_posts_migration.png "Post migration")
...
![running Post migration](images/rails_running_db_migrate_01.png "running Post migration")
...
![Posts browsing](images/rails_browser_posts.png "Posts browsing")
...
![Manipulating records via the console](images/rails_console.png "Manipulating records via the console")
...
## Resources
	...
	* [Rails code on GitHub](https://github.com/rails/rails)